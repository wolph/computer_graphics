...
const Vec3Df& performRayTracing(const Vec3Df & origin, const Vec3Df & dest){
    ...
    //performRayTracingArend(ray);
    //performRayTracingEwoud(ray);
    //performRayTracingLeon(ray);
    performRayTracingMax(ray);
    //performRayTracingQu(ray);
    //performRayTracingRick(ray);
    //performRayTracingRutger(ray);
    //performRayTracingVince(ray);
    //performRayTracingYmte(ray);
    return ray.getColor();
}
